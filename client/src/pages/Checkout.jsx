                    ...
                    <div className="lg:w-96 w-full bg-white rounded-lg p-5 shadow-sm border border-gray-200 h-fit sticky top-20">
                        ...
                        <div className="mb-6">
                            ...
                            <div className="relative flex justify-between items-start mt-2">
                                ...
                                <button onClick={() => setShowAddress(!showAddress)} className="text-primary hover:underline cursor-pointer text-sm">
                                    Changer
                                </button>
                                {showAddress && (
                        ...
                        <div className="text-gray-500 mt-4 space-y-2">
                            <p className="flex justify-between">
                                <span>Sous-total</span><span>{originalAmount} {currency}</span>
                            </p>
                            {appliedCoupon && (
                            ...
                            <p className="flex justify-between text-lg font-medium mt-3 pt-2 border-t">
                                <span>Total</span><span>{finalAmount} {currency}</span>
                            </p>
                        </div>
