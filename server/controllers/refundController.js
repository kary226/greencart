...
/**
 * Récupère tous les remboursements (filtrés par statut).
...
export const approveRefund = async (req, res) => {
    try {
        ...
        // Vérifier que l'approbateur est différent du demandeur
...
/**
 * Marque un remboursement comme effectué (manuel).
...
const executerRefund = async (refund, acteur) => {
    // Si le remboursement est en RCOINS
